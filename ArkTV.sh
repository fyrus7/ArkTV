...
JSON_URL="https://raw.githubusercontent.com/fyrus7/ArkTV/main/channels.json" # https://raw.githubusercontent.com/AeolusUX/ArkTV/refs/heads/main/channels/channels.json
